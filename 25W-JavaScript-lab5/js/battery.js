...
const imgHolder= document.querySelector('#battery dd:nth-of-type(3)');
...
function updateBatteryStatus(battery) {
    ...
    importImg(battery.level * 100,battery.charging);

}
function importImg(batterylevel,batterycharging){
    while (imgHolder.firstChild) {
        imgHolder.removeChild(imgHolder.firstChild);
    };
    var fullUrl=`${baseUrl}${batterylevel}percentage${batterycharging}.png`
